      ...
      <div>
        <footer className="footer bg-[#1E293BEE] p-10 text-base-content">
          ...
          <nav>
            ...
            <Link className="link link-hover text-base">
              <AiOutlineMail className="text-lg  inline mr-2" />
              serviceSquad@gmail.com
            </Link>
            <Link className="link link-hover text-base max-w-xs">
          ...
          <nav>
            ...
            <Link className="link link-hover">ios</Link>
